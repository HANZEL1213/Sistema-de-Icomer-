{{-- resources/views/admin/carrusel/create.blade.php --}}
    ...
    <div class="card card-form">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-3">
                <div>
                    <h4 class="fw-bold text-uppercase mb-1">Nuevo Banner</h4>
                    <small class="text-muted">Agrega un nuevo elemento al carrusel</small>
                </div>
            ...
            <form action="{{ route('admin.carrusel-items.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card border-0 bg-light mb-3">
                            <div class="card-body text-center">
                                ...
                                <div class="image-box banner-image-box mb-3 position-relative">
                                    ...
                                    <img id="preview" src="" data-placeholder=""
                                        class="img-fluid rounded shadow-sm d-none" alt="Vista previa de imagen">
                        ...
                        <div class="card border-0 bg-light">
                            <div class="card-body">
                                ...
                                @php
                                    $activoManualOld = old('activo_manual', '1');
                                    $activoManual =
                                        $activoManualOld == '1' ||
                                        $activoManualOld === 1 ||
                                ...
                                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        <span id="estadoActivoTexto"
                                            class="btn {{ $activoManual ? 'btn-primary-custom' : 'btn-secondary-custom' }} btn-sm px-3 py-2 d-inline-flex align-items-center">
                                            @if ($activoManual)
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card border-0 bg-light mb-3">
                            <div class="card-body">
                                ...
                                @php
                                    $ordenOld = old('orden_programado', 1);
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" name="subtitulo"
                                        ...
                                        placeholder=" " value="{{ old('subtitulo') }}">
                                ...
                                <div class="form-floating">
                                    <input type="text" name="texto_boton"
                                        ...
                                        placeholder=" " value="{{ old('texto_boton') }}">
                        ...
                        <div class="card border-0 bg-light">
                            <div class="card-body">
                                ...
                                @php
                                    $tipoDestinoOld = old('tipo_destino');
                                @endphp
                                ...
                                <div id="campoUrl" class="{{ $tipoDestinoOld === 'url' ? '' : 'd-none' }}">
                                    <input type="url" name="url_destino"
                                        ...
                                        placeholder="https://..." value="{{ old('url_destino') }}">
                                    @error('url_destino')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
