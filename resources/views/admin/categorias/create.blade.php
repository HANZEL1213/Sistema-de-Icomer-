    ...
    <div class="card card-form">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <h4 class="fw-bold text-uppercase mb-1">Nueva Categoría</h4>
                    <small class="text-muted">Registra una nueva categoría</small>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-floating">
                                    <textarea name="descripcion" id="descripcion" class="form-control @error('descripcion') is-invalid @enderror"
                                        placeholder="Descripción" style="height: 120px">{{ old('descripcion') }}</textarea>
