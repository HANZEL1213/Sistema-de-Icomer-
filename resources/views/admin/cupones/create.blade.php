                            ...
                            <div class="card-body">
                                ...
                                <div class="input-group custom-dark-input">
                                    ...
                                    <input type="text" id="codigo" name="codigo"
                                        ...
                                        placeholder="Ej: BIENVENIDA10" value="{{ old('codigo') }}" required>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="input-group custom-dark-input">
                                    ...
                                    <input type="number" step="0.01" min="0" id="minimo_subtotal"
                                        ...
                                        placeholder="0.00" value="{{ old('minimo_subtotal', 0) }}">
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" min="1" id="max_usos_total" name="max_usos_total"
                                        ...
                                        placeholder="Ej: 100" value="{{ old('max_usos_total') }}">
                                ...
                                <div>
                                    ...
                                    <input type="number" min="1" id="max_usos_por_usuario"
                                        ...
                                        placeholder="Ej: 1" value="{{ old('max_usos_por_usuario') }}">
