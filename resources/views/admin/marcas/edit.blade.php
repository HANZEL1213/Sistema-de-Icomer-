    ...
    <div class="card card-form">
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <h4 class="fw-bold text-uppercase mb-1">Editar Marca</h4>
                    <small class="text-muted">Modifica la marca</small>
                </div>
            ...
            <form action="{{ route('admin.marcas.update', $item->id_marca) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
