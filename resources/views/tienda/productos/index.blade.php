                    ...
                    <form action="{{ route('tienda.productos.index') }}" method="GET" id="mobileFilterForm">
                        ...
                        <div class="store-filter-group">
                            ...
                            <select name="orden" class="form-select store-filter-control">
                                ...
                                <option value="precio_menor" {{ request('orden') == 'precio_menor' ? 'selected' : '' }}>
                                    Precio menor
                                </option>
                                <option value="precio_mayor" {{ request('orden') == 'precio_mayor' ? 'selected' : '' }}>
                                    Precio mayor
                                </option>
        ...
        <div class="row g-4">
            ...
            <div class="col-12 col-lg-9 order-1 order-lg-2">
                <div class="store-products-toolbar">
                    ...
                    <a href="{{ route('tienda.categorias.index') }}" class="btn btn-store-outline d-none d-md-inline-flex">
                        Ver categorías
                    </a>
                </div>
                        ...
                        <div class="col-6 col-md-4 col-xl-3">
                            <div class="store-product-card">
                                <a href="{{ route('tienda.productos.show', $producto->slug) }}" class="store-product-image-wrap">
                                    <img src="{{ $imagen }}" alt="{{ $producto->nombre }}" class="store-product-image">
                                    <button type="button" class="store-product-heart">
                                ...
                                <div class="store-product-body">
                                    <div class="store-product-meta">{{ $producto->marca?->nombre ?? 'Sin marca' }}</div>
                                    <a href="{{ route('tienda.productos.show', $producto->slug) }}" class="store-product-name">
                                        {{ $producto->nombre }}
                                    </a>
                                    <div class="store-product-category">{{ $producto->categoriaPrincipal?->nombre ?? 'Sin categoría' }}</div>
                                    <div class="store-product-footer">
                                        <div>
                                            <div class="store-product-price">₡{{ number_format($producto->precio, 2) }}</div>
                                            <small class="store-product-stock">Stock: {{ $producto->stock_actual }}</small>
                                        </div>
                                        <a href="{{ route('tienda.productos.show', $producto->slug) }}" class="store-product-action">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </div>
                                </div>
