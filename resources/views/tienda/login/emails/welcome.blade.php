        ...
        <tr>
            <td align="center">
                <table width="100%" cellpadding="0" cellspacing="0"
                    style="max-width:540px; background:#ffffff; border-radius:22px; overflow:hidden; border:1px solid #e5e7eb;">
                    <tr>
                        <td style="padding:34px 30px; text-align:center;">
                            ...
                            <div
                                style="margin-top:24px; background:#f9fafb; border:1px solid #e5e7eb; border-radius:18px; padding:22px; text-align:left;">
                                <p style="margin:0; color:#374151; font-size:14px; line-height:1.7;">
                                    Ahora puedes consultar tus pedidos, guardar favoritos y gestionar tu información
                                    desde tu cuenta.
                                </p>
                            </div>
